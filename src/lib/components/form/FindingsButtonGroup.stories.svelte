<script module lang="ts">
  ...
  async function assertNoWidthShiftOnToggle({
    canvasElement,
  }: {
...
<Story
  name="Multi-Select (Indication)"
  args={{ group: multiSelectGroup }}
  play={assertNoWidthShiftOnToggle}
/>

<Story
  name="Multi-Select with Exclusive"
  args={{ group: multiSelectExclusiveGroup }}
/>
