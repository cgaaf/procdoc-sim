...
<Story name="FAST Presets" args={{ presets: examConfigs.fast.presets }} />

<Story
  name="DVT Presets"
  args={{ presets: examConfigs.dvt.presets }}
  decorators={[
