  ...
  {#each parts as part, i (i)}
    {#if part.kind === "staticText"}
      <span
        ...
        style:color="var(--color-text-primary)">{part.text}</span
      >
    ...
    {:else if part.kind === "me"}
      <span
        ...
        style:color="var(--color-text-primary)">[Current User]</span
      >
    {:else if part.kind === "now"}
      <span
        class="font-epic text-[13px] font-bold"
        style:color="var(--color-text-primary)">[Current Time]</span
      >
