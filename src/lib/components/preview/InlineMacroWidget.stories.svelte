<script module lang="ts">
	...
	const { Story } = defineMeta({
		title: 'Preview/InlineMacroWidget',
		component: InlineMacroWidget,
		tags: ['autodocs'],
		decorators: [
...
<Story
	...
	args={{
		macroId: 'macro_3',
		options: ['Normal no effusion', 'Effusion'],
		blankSingle: false
	}}
/>
...
<Story
	...
	args={{
		macroId: 'macro_4',
		options: ['Normal no free fluid', 'Free fluid'],
		blankSingle: true
	}}
/>
...
<Story
	...
	args={{
		...
		options: ['Completely compressible', 'Incompletely compressible', 'Clot seen within the vein', 'Not obtained'],
		blankSingle: false
	}}
/>
