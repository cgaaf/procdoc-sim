    ...
    },
    {
      ...
      findings: [
        ...
        },
        {
          ...
          findingLabel: "Cardiac activity",
          macroId: "echo_cardiac_activity",
          presentOptions: ["Absent"],
          absentOption: "Present",
          triState: true,
          triStateLabels: { present: "Absent", absent: "Present", indeterminate: "Indeterminate" },
        },
        {
          kind: "buttonGroup",
          label: "LV Function",
        ...
        {
          kind: "buttonGroup",
          label: "Pericardial Effusion Size",
          macroId: "echo_pericardium_size",
          options: ["Small", "Moderate", "Large"],
          multiSelect: false,
          exclusiveOptions: new Set(),
          commentable: true,
          visibleWhen: { macroId: "echo_pericardium", value: "Present" },
        },
        {
          kind: "findingRow",
          label: "Tamponade Physiology",
          findingLabel: "Tamponade physiology",
          macroId: "echo_tamponade",
          presentOptions: ["Present"],
          absentOption: "Absent",
          triState: true,
          triStateLabels: { present: "Present", absent: "Absent", indeterminate: "Indeterminate" },
      ...
      findings: [
        {
          kind: "findingRow",
          label: "Wall Motion",
          findingLabel: "Wall motion",
          macroId: "echo_wall_motion",
          presentOptions: ["Abnormal"],
          absentOption: "Normal",
          triState: true,
          triStateLabels: { present: "Abnormal", absent: "Normal", indeterminate: "Indeterminate" },
        },
        {
          kind: "findingRow",
          label: "Valvular Abnormality",
          findingLabel: "Valvular abnormality",
          macroId: "echo_valvular",
          presentOptions: ["Present"],
          absentOption: "Absent",
          triState: true,
          triStateLabels: { present: "Present", absent: "Absent", indeterminate: "Indeterminate" },
        },
        {
          ...
          label: "EPSS",
          macroId: "echo_epss",
          options: ["Normal (<7mm)", "Abnormal (≥7mm)", "Indeterminate"],
          multiSelect: false,
          exclusiveOptions: new Set(),
          commentable: true,
        },
        {
          ...
          label: "TAPSE",
          macroId: "echo_tapse",
          options: ["Normal (≥17mm)", "Abnormal (<17mm)", "Indeterminate"],
          multiSelect: false,
          exclusiveOptions: new Set(),
          commentable: true,
        },
    ...
    },
    {
      ...
      findings: [
        ...
        },
        {
          ...
          macroId: "echo_lung_sliding_left",
          presentOptions: ["Absent"],
          absentOption: "Present",
          triState: true,
          triStateLabels: { present: "Absent", absent: "Present", indeterminate: "Indeterminate" },
        ...
        },
        {
          ...
          findingLabel: "Lung sliding",
          macroId: "echo_lung_sliding_right",
          presentOptions: ["Absent"],
          absentOption: "Present",
          triState: true,
          triStateLabels: { present: "Absent", absent: "Present", indeterminate: "Indeterminate" },
      ...
      findings: [
        {
          ...
          options: ["Absent", "Small amount", "Present", "Large amount", "Indeterminate"],
          multiSelect: false,
          exclusiveOptions: new Set(),
          commentable: true,
        },
