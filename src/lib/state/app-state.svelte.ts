...
export class AppState {
  ...
  applyNormalCardiac() {
    this.macroSelections.setIfEmpty("macro_3", "Negative");
  ...
  applyNormalAbdomen() {
    this.macroSelections.setIfEmpty("macro_4", "Negative");
    this.macroSelections.setIfEmpty("macro_5", "Negative");
    this.macroSelections.setIfEmpty("macro_6", "Negative");
    this._updateFastInterpretation();
    this._syncViewsFromFindings();
  }
  ...
  applyNegativeFAST4() {
    this.macroSelections.set("macro_3", "Negative");
    this.macroSelections.set("macro_4", "Negative");
    this.macroSelections.set("macro_5", "Negative");
    this.macroSelections.set("macro_6", "Negative");
    this._updateFastInterpretation();
    this._syncViewsFromFindings();
  }
  ...
  private _hasAnyIndeterminateFinding(): boolean {
    ...
    if (this.macroSelections.getMulti("macro_7_left").has("Indeterminate")) return true;
    if (this.macroSelections.getMulti("macro_7_right").has("Indeterminate")) return true;
    return false;
  }
  ...
  private _isAbdominalAllNegative(): boolean {
    return (
      this.macroSelections.get("macro_4") === "Negative" &&
      this.macroSelections.get("macro_5") === "Negative" &&
      this.macroSelections.get("macro_6") === "Negative"
    );
  }
